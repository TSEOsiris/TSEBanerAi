...
namespace OverlayTest.Autocomplete
{
    ...
    public class EntityContextBuilder
    {
        ...
        /// </summary>
        /// <param name="changeStart">Position where change started</param>
        /// <param name="oldLength">Length of removed text</param>
        /// <param name="newLength">Length of inserted text</param>
        ...
        /// </summary>
        /// <returns>Formatted context for LLM prompt</returns>
